        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-lg-8 mb-5 mb-lg-0">
                    <div class="card card-dicussions mb-5">
                        <div class="row">
                            ...
                            <div class="col-11">
                                ...
                                <div class="mb-3">
                                    <a href="#"><span class="badge rounded-pill text-bg-light">Facede</span></a>
                                </div>
                                <div class="row align-items-start justify-content-between">
                                    ...
                                    <div class="col-5 col-lg-3 d-flex">
                                        <a href="#" class="card-discussions-show-avatar-wrapper flex-shrink-0 rounded-cricle overflow-hidden me-1">
                                            <img src="{{ url('assets/images/avatar.png') }}" alt="" class="avatar">
                                        </a>
                                        <div class="fs-12px 1h-1">
                                            <span class="text-primary">
                                                <a href="#" class="fw-bold d-flex align-items-start text-break mb-1">
                                                    lukas
                                                </a>
                                            </span>
                                            <span class="color-gray">30 minutes ago</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="fw-bold text-center">Please <a href="#" class="text-primary">sign in</a> or <a href="#" class="text-primary">create an account</a> participate in this discussion.</div>
