...
@section('body')
    <section class="bg-gray pt-4 pb-5">
        <div class="container">
            <div class="row">
                <div class="clo-12 col-lg-4 mb-5 mb-lg-0">
                    <div class="d-flex mb-4">
                        <div class="avatar-wrapper rounded-cricle overflow-hidden flex-shrink-0 me-4">
                                    ...
                                    <div class="col-12 col-lg-10">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-5 col-lg-4">
                                                <div class="avatar-sm-warpper d-inline-block">
                                                    <a href="#" class="me-1">
                                                        <img src="{{ url('assets/images/avatar-sm.png') }}" alt="Kimsomay" class="avatar rounded-cricle">
                                                    </a>
                                                </div>
                                                <span class="fs-12px">
